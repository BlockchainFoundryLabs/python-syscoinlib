# Copyright (C) 2012-2015 The python-syscoinlib developers
#
...
class CScript(bytes):
    ...
    def __coerce_instance(cls, other):
        ...
        if isinstance(other, CScriptOp):
            ...
            if 0 <= other <= 16:
                ...
                other = CScriptOp.encode_op_pushdata(syscoin.core._bignum.bn2vch(other))
    ...
    def to_p2sh_scriptPubKey(self, checksize=True):
        ...
        return CScript([OP_HASH160, syscoin.core.Hash160(self), OP_EQUAL])
...
def RawSignatureHash(script, txTo, inIdx, hashtype):
    ...
    txtmp = syscoin.core.CMutableTransaction.from_tx(txTo)
    ...
    if (hashtype & 0x1f) == SIGHASH_NONE:
        ...
        for i in range(outIdx):
            txtmp.vout.append(syscoin.core.CTxOut())
