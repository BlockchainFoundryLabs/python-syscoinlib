...
class CBlock(CBlockHeader):
    ...
    def build_merkle_tree_from_txids(txids):
        ...
        duplicate txids, resulting in a vulnerability. (CVE-2012-2459) Syscoin
...
class CoreChainParams(object):
    """Define consensus-critical parameters of a given instance of the Syscoin system"""
    MAX_MONEY = None
    GENESIS_BLOCK = None
...
def _SelectCoreParams(name):
    ...
    Don't use this directly, use syscoin.SelectParams() instead so both
