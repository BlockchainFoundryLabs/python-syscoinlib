...
import socket, time, syscoin
from syscoin.messages import msg_version, msg_verack, msg_addr
from syscoin.net import CAddress
...
# receive version message: /pythonsyscoin0.0.1/: version 70002, blocks=-1, us=192.168.0.149:18333, them=192.168.0.13:18333, peer=192.168.0.13:39979
